...
NICHE_SLOTS = {
    ...
    "footwork":   6,  # equally important: gait quality
    "stability":  4,
    "efficiency": 4,
}
...
FIT_LIFTED_FOOT_GAIN     = 0.015  # per frame per airborne foot (encourages leg motion)
FIT_UPRIGHT_GAIN         = 0.02   # slight upright bonus (reduced, no longer the exploit)
